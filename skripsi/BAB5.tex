...
\begin{enumerate}
    ...
    \item Penerapan \texit{Long Short Term Memory} pada flow header paket dapat melakukan profiling jaringan dengan baik. Parameter yang diukur untuk menentukan terjadinya flow header anomali dan normal adalah persentase loss dari model LSTM
\end{enumerate}
\section{Saran}
\begin{enumerate}
